...
namespace FloatWP\Blocks;

use FloatWP\Blocks\Example;
...
function register_theme_blocks() {
	...
	require_once FLOATWP_BLOCK_DIR . '/example-block/register.php';
...
function blocks_editor_styles() {
	wp_enqueue_style(
		'editor-style',
		FLOATWP_TEMPLATE_URL . '/dist/css/editor-style.css',
		[],
		FLOATWP_VERSION
	);
